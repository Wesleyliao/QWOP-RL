...
(function () {
    var n = {},
        ...
        q = !1;
    try {
        "undefined" !== typeof AudioContext ? (g = new AudioContext()) : "undefined" !== typeof webkitAudioContext ? (g = new webkitAudioContext()) : (l = !1);
    } catch (z) {
        l = !1;
    }
    if (!l)
    ...
    t.prototype = {
        volume: function (a) {
            ...
            if (0 <= a && 1 >= a) {
                ...
                for (var b in this._howls)
                    if (this._howls.hasOwnProperty(b) && !1 === this._howls[b]._webAudio) for (a = 0; a < this._howls[b]._audioNode.length; a++) this._howls[b]._audioNode[a].volume = this._howls[b]._volume * this._volume;
                return this;
            }
        ...
        _setMuted: function (a) {
            ...
            for (var b in this._howls) if (this._howls.hasOwnProperty(b) && !1 === this._howls[b]._webAudio) for (var c = 0; c < this._howls[b]._audioNode.length; c++) this._howls[b]._audioNode[c].muted = a;
        },
        codecs: function (a) {
        ...
        _enableiOSAudio: function () {
            ...
            if (!g || (!a._iOSEnabled && /iPhone|iPad|iPod/i.test(navigator.userAgent))) {
                ...
                var b = function () {
                    ...
                    setTimeout(function () {
                        if (d.playbackState === d.PLAYING_STATE || d.playbackState === d.FINISHED_STATE) (a._iOSEnabled = !0), (a.iOSAutoEnable = !1), window.removeEventListener("touchstart", b, !1);
                    }, 0);
                };
    ...
    r.prototype = {
        load: function () {
            ...
            if (!q) {
                for (var c = 0; c < a._urls.length; c++) {
                    ...
                    else if (((e = a._urls[c]), (d = /^data:audio\/([^;,]+);/i.exec(e)) || (d = /\.([^.]+)$/.exec(e.split("?", 1)[0])), d)) d = d[1].toLowerCase();
                    else {
                        a.on("loaderror");
                        return;
                    }
        ...
        play: function (a, b) {
            ...
            c._inactiveNode(function (d) {
                ...
                var e = 0 < d._pos ? d._pos : c._sprite[a][0] / 1e3,
                    f = 0;
                c._webAudio ? ((f = c._sprite[a][1] / 1e3 - d._pos), 0 < d._pos && (e = c._sprite[a][0] / 1e3 + e)) : (f = c._sprite[a][1] / 1e3 - (e - c._sprite[a][0] / 1e3));
                ...
                (function () {
                    l = setTimeout(function () {
                        ...
                        c._webAudio && !h && ((c._nodeById(m).paused = !0), (c._nodeById(m)._pos = 0), c._clearEndTimer(m));
                ...
                if (c._webAudio) {
                    ...
                    "undefined" === typeof d.bufferSource.start ? (h ? d.bufferSource.noteGrainOn(0, e, 86400) : d.bufferSource.noteGrainOn(0, e, f)) : h ? d.bufferSource.start(0, e, 86400) : d.bufferSource.start(0, e, f);
        ...
        pos: function (a, b) {
            ...
            a = parseFloat(a);
            var d = b ? c._nodeById(b) : c._activeNode();
            if (d) return 0 <= a ? (c.pause(b), (d._pos = a), c.play(d._sprite, b), c) : c._webAudio ? d._pos + (g.currentTime - c._playStart) : d.currentTime;
            if (0 <= a) return c;
            for (d = 0; d < c._audioNode.length; d++) if (c._audioNode[d].paused && 4 === c._audioNode[d].readyState) return c._webAudio ? c._audioNode[d]._pos : c._audioNode[d].currentTime;
        },
        ...
        unload: function () {
            for (var a = this._audioNode, b = 0; b < this._audioNode.length; b++) a[b].paused || (this.stop(a[b].id), this.on("end", a[b].id)), this._webAudio ? a[b].disconnect(0) : (a[b].src = "");
    ...
    if (l)
        var x = function (a, b) {
                if (b in n) (a._duration = n[b].duration), v(a);
                    ...
                    f.onerror = function () {
                        a._webAudio && ((a._buffer = !0), (a._webAudio = !1), (a._audioNode = []), delete a._gainNode, delete n[b], a.load());
                    };
                    try {
                        f.send();
                    } catch (g) {
